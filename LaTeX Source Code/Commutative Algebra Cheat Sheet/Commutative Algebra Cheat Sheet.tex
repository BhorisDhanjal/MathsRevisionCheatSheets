...
\begin{tikzpicture}
	\node [mybox] (box){%
		\begin{minipage}{0.3\textwidth}
			The \textbf{nilradical} of a ring $A$ is denoted by $\mathfrak{N}_R$ and consists of the set of all nilpotent elements of $A$. Equivalently it is the intersection of all prime ideals.
			
			This shows that a radical of an ideal is just the intersection of prime ideals containing it. 
			
			The \textbf{Jacobson} radical of a ring $A$ is the intersection of all its maximal ideals.
		\end{minipage}
	};
